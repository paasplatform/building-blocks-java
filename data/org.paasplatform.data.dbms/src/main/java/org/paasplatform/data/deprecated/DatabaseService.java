...
import org.paasplatform.data.deprecated.xml.SchemaMeta;
import org.paasplatform.data.deprecated.xml.TableMeta;
...
import static org.paasplatform.data.deprecated.ColumnLabel.COLUMN_NAME;
import static org.paasplatform.data.deprecated.ColumnLabel.TABLE_NAME;
...
public class DatabaseService {
    ...
    public void gatherSchemaDetails(Database db, SchemaMeta schemaMeta) throws SQLException {
...
//        listener.finishedConnectingTablesViews();
     ...
     * @throws SQLException
     */
    private void initTables(Database db, final DatabaseMetaData metadata) throws SQLException {
     ...
     * @throws SQLException
     */
    private void initViews(Database db, DatabaseMetaData metadata) throws SQLException {
...
//                listener.tableViewCollected(view);
    ...
    private void connectTables(Database db) {
